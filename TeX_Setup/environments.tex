...
\newtheorem*{lnotation}{Local Notation}
\newenvironment{boxlnotation}{
    \begin{tcolorbox}[colback=magenta!3!white,colframe=magenta!70!black, breakable, enhanced]\begin{lnotation}
}{
    \end{lnotation}\end{tcolorbox}
}
\newtheorem*{abbreviation}{Abbreviation}
\newenvironment{boxabbrev}{
    \begin{tcolorbox}[colback=magenta!3!white,colframe=magenta!70!black, breakable, enhanced]\begin{abbreviation}
}{
    \end{abbreviation}\end{tcolorbox}
}
\newtheorem*{warning}{Warning}
\newenvironment{boxwarning}{
    \begin{tcolorbox}[colback=red!50!white,colframe=red!50!black, breakable, enhanced]\begin{warning}
}{
    \end{warning}\end{tcolorbox}
}
...
% Proofs of an "if and only if", whose two directions are the two items of a
% `description`. The order of the directions is left to each proof.
\newenvironment{iffproof}{
    \begin{proof} \hfill \begin{description}
}{
    \end{description} \end{proof}
}
\newcommand{\ifdir}{\item[$\parenth{\impliedby}$]}
\newcommand{\onlyifdir}{\item[$\parenth{\implies}$]}
