...
\begin{proof}
    ...
    If every finite subgraph can be $k$-colored, then for all finite $J \ssq E(G)$, $\bigcap_{e \in J} P_{e} \ne \emptyset$ \sorry
    % The sorry above: the proof stops here. What is missing is why that intersection is nonempty (color the finite subgraph spanned by $J$ properly and extend arbitrarily), and the conclusion: the finite intersection property then gives $\bigcap_{e \in E(G)} P_e \ne \emptyset$, and any element of that is a proper $k$-coloring of $G$.
\end{proof}
