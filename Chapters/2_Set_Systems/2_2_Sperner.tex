...
A hypergraph is a vertex set together with a family of subsets of it, and the next question this chapter asks about one is how large that family can be. Unrestricted the question is dull---all $2^n$ subsets of $[n]$ form a hypergraph---so we forbid the cheapest way of making a family large, which is to pile sets up inside one another.
...
% $d_1 = n - k$ and $d_2 = k + 1$.
An intuitive way of arguing is to find complete matchings of the $k$th layer into the $(k + 1)$th layer (cf. \Cref{Ch2:Cor:Biregular}), but at some point, this starts to break down. And at what point is that? Before $k$ exceeds $n / 2$.
