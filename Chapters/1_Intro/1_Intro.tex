...
\begin{boxnotation} \hfill
    \begin{itemize}
        ...
        \item $\H$ will denote the set of hyper-edges of a hypergraph $H$, and likewise for any other letter.
    \end{itemize}
\end{boxnotation}
