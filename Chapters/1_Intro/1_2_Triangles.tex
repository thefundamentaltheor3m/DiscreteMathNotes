...
The other thing worth having in hand is the random graph itself.
...
\Cref{Ch2:Thm:Erdos_Girth} will use $G_{n, p}$ to build a graph with no short cycles, where all that matters is that short cycles are scarce. The question here is a sharper one: for which $p$ does $G_{n, p}$ contain a triangle at all?
