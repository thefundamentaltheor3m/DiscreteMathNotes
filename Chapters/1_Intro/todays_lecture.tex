...
\begin{boxexample}[Some Adjacency Matrices of Hypergraphs] \hfill
    \begin{enumerate}
        ...
        % also the transpose of the matrix in the item above, which may be what was intended. Left as written. This
        % qualifies the correspondence claimed below the example: it runs between hypergraphs and those $0,1$ matrices
        % whose columns are distinct, up to permutation of the rows and of the columns.
        \begin{align*}
            \begin{bmatrix}
                1 & 1 & 1 & 1 & 0 \\
                0 & 0 & 1 & 1 & 0 \\
