...
Coloring is back, and this time we are not rationed to two colors. \Cref{Ch1:CH} opened by asking which graphs can be colored with two colors; the question now is how many colors a graph needs in general, and how far that number can be pushed away from the obvious lower bound.
