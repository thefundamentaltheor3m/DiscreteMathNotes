...
\end{boxtheorem}
\begin{proof}
    Given a hypergraph with $< 2^{k-1}$ edges, randomly color the vertices red and blue, with equal probability ($1/2$) for each. For each edge $f$, let $\mathcal{E}_f$ be the event that $f$ is monochromatic. Then,
    \begin{align*}
...
\begin{boxtheorem}[\Erdos-Selfridge]
