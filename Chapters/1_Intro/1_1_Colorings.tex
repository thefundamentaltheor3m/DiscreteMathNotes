...
\begin{boxdefinition}[Hypergraph] \label{Ch1:Def:Hypergraph}
    Given a vertex set $V$, a \textbf{hypergraph} is a pair $H = \parenth{V, \H}$, where $\H$ is a collection of subsets of $V$. The sets in $\H$ are called \textbf{hyperedges}.
\end{boxdefinition}
...
In the language of hypergraphs, the game is $2$-coloring; maker winning is equivalent to the existence of a coloring with a monochromatic edge; and breaker winning is equivalent to the inexistence of such edge.
