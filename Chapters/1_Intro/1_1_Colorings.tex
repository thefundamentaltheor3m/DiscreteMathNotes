...
\Cref{Ch1:Thm:mk_Lower_Bound} says that a hypergraph with few enough edges has a proper $2$-colouring somewhere among all the colourings of its vertices. It turns out that the very same threshold survives a far more demanding requirement: that one of two players be able to build such a colouring one vertex at a time, against an opponent trying to stop them.
