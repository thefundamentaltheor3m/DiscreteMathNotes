...
\begin{boxdefinition}[Chromatic Number] \label{Ch1:Def:Chromatic_Number}
...
\begin{proof}[Proof of \Cref{Ch1:Thm:Erdos_Girth}]
    ...
    By Markov's inequality (\Cref{Ch3:Thm:Markov}, which we get round to stating only in \Cref{Ch3:CH}),
    \begin{align*}
