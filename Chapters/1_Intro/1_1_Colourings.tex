...
To see this, call a pair of vertices \textbf{covered} if some edge of $H$ contains both of them; an uncovered pair is exactly what we are after. Now count. An edge has $3$ vertices, so it covers the $\binom{3}{2} = 3$ pairs among them, and $H$ has at most $6$ edges, so at most
\begin{align*}
    6 \cdot \binom{3}{2} = 18
\end{align*}
