...
Given a hypergraph $H$, a family of distinct representatives is a collection of distinct $x_1, \ldots, x_m$ such that $x_i \in f_i$, where we have distinct hyper-edges $f_1, \ldots, f_m$ in $\H$. Such a collection exists iff for any collection $\calC$ of hyper-edges,
\begin{align*}
