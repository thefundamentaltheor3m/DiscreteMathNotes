...
\begin{boxexample}[Some Adjacency Matrices of Hypergraphs] \hfill
    \begin{enumerate}
        ...
        \item Consider the hypergraph
        % The matrix below had a repeated column, so it was the adjacency matrix of no hypergraph with that many
        % hyper-edges; the duplicate is dropped. Note that the correspondence claimed after this example runs between
        % hypergraphs and those $0,1$ matrices whose columns are distinct, up to permutation of rows and of columns.
        \begin{align*}
            \begin{bmatrix}
                1 & 1 & 1 & 0 \\
                0 & 1 & 1 & 0 \\
