...
Hypergraphs came up in \Cref{Ch1:Def:Hypergraph} as the setting in which the coloring question gets hard, and we set them aside when the Ramsey numbers took us back to graphs. This section asks something else of them: given a hypergraph, can we pick one vertex out of each edge, all of them different? Getting to the answer means first noticing that a hypergraph, a $0,1$ matrix and a bipartite graph are three views of the same data.
...
\begin{boxtheorem} \label{Ch1:Cor:Biregular}
