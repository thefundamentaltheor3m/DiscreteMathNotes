...
% 21 Sep 2026
%
% Parked here by /integrate. The rest of this lecture went to 2.4, The Chromatic Number of the Plane.
% What is left is Beck's theorem (not named in the lecture), stated without proof. It is not a step in
% the compactness theorem of 2.4.2; its standard proof is the local lemma above applied to finite
% words, followed by a compactness argument like the one in 2.4.2. So it waits beside the local lemma
% until the lecture comes back to both.

Apart from topology (cf. \Cref{Ch2:Lemma:Compactness}), our argument will involve binary sequences. First, a theorem.
